...
export function DestinationLuxuryDetails({ details }: DestinationLuxuryDetailsProps) {
  return (
    <SectionContainer variant="pearl" paddedTop>
      ...
      <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-brand-charcoal/[0.06] bg-brand-charcoal/[0.06] sm:grid-cols-2">
        {details.map((detail, i) => (
          <Reveal key={detail.title} delay={0.04 * i}>
            <div className="h-full bg-brand-white p-8 sm:p-9 lg:p-10">
